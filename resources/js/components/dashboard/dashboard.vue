  ...
  methods: {
    ...
    fetchServices() {
      if (this.selectedAgence) {
        axios.get(`/agence/${this.selectedAgence.id}/services`)
          .then(response => {
            this.services = response.data;
            this.selectedService = null; // Reset selectedService when agence changes
          })
          .catch(error => {
  ...
  watch: {
    ...
    selectedService(newValue) {
      if (newValue) {
        ...
        if (this.selectedAgence) {
          this.name = 'agence';
          this.name_id = this.selectedAgence.id;
        } else {
          this.name = 'agencies';
          this.name_id = '';
        }
