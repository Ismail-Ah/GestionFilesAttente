    ...
    <div class="frame">
        <div class="div">
            ...
            <div class="group">
                ...
                <div class="overlap-2"><a class="text-wrapper-4" href="<?php echo e(route('register')); ?>">Sign Up</a></div>
                <div class="overlap-3"><a class="text-wrapper-5" href="<?php echo e(route('login')); ?>">Log In</a></div>
            </div>
...
<?php /**PATH D:\Documents\stage\project\resources\views\homepage.blade.php ENDPATH**/ ?>